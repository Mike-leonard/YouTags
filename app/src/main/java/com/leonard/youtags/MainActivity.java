...
import com.leonard.youtags.adapter.CategorieAdapter;
import com.leonard.youtags.db.DataBaseHelper;
import com.leonard.youtags.module.Categorie;
import java.io.File;
...
public class MainActivity extends AppCompatActivity implements CategorieAdapter.ItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdConstantControl.bannerAdControl(MainActivity.this, R.id.unitads, rootView);
    ...
    public void onItemClick(View view, int position) {
        ...
        if (random == 2) {
            AdConstantControl.adControl(MainActivity.this);
        }
    }
    ...
    /*private void appRuningTimes (final int timer) {
        ...
        handler.postDelayed(new Runnable() {
            public void run() {
                ...
                handler.postDelayed(this, timer + 120000 ); //now is every 2 minutes
            }
        }, timer);
    }*/
